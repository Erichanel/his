...
from data.datasets import HSIPatchExtractor, HSIDataset  # noqa: E402
from sspq_tokenizer.joint_tokenizer import SSPQTokenizer  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        required=False,
        default=str(PROJECT_ROOT / "configs/tokenizer.yaml"),
        help="Path to configs/tokenizer.yaml",
    )
